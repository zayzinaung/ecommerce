var Index = function () {
    ...
    return {
        ...
        initDashboardDaterange: function () {
            $('#dashboard-report-range').attr('ReadOnly','true');
            $('#dashboard-report-range').css('cursor','pointer');
         ...
         initIntro: function () {
            ...
            $.extend($.gritter.options, {
                ...
                setTimeout(function () {
                    var unique_id = $.gritter.add({
                        ...
                        title: '<a href="http://evercrystal.com" target="_blank">Get Crystal HR Just For 25$</a>',
                        // (string | mandatory) the text inside the notification
                        text: 'Crystal HR is World\'s #1 Selling HR System Ever! 18000+ Users Can\'t be Wrong.',
            ...
            if (!$.cookie('intro_show')) {
                ...
                setTimeout(function () {
                    ...
                    var unique_id = $.gritter.add({
                        // (string | mandatory) the heading of the notification
                        title: '<a id="styler" href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" target="_blank">Customize Metronic!</a>',
                        // (string | mandatory) the text inside the notification
