...
<div class="page-content">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="{{URL::to('admin/header_cms')}}">Header Information</a>
				<i class="fa fa-angle-right"></i>
			</li>
			<li>
				Header Menu List
	...
	<div class="portlet box blue-madison">
		<div class="portlet-title">
			<div class="caption">
				<span aria-hidden="true" class="icon-compass"></span> Header Menu Management
			</div>
			<div class="tools">
		...
		<div class="portlet-body">
			...
			<div class="table-toolbar">
				@if(User::hasPermTo(MODULE,'edit'))
					<div class="btn-group">
						<a href="{{ URL::to('admin/header_cms/order_menu') }}" >
					...
					<tbody>
						...
						@foreach ($header_menu as $row)
							...
							<tr>
								...
								<td>
									@if(User::hasPermTo(MODULE,'edit'))
										{{ Form::open(array('url'=>'admin/header/is_active', 'class'=>'form-horizontal')) }}
										{{ Form::hidden('id', $row->id) }}
								            	@if($row->header_active == 1)
