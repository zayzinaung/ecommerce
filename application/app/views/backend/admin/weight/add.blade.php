		...
		<div class="col-md-7">
			...
			<div class="portlet box blue-madison">
				...
				<div class="portlet-body form">
					<!-- BEGIN FORM-->
					{{ Form::open(array('url'=>'admin/weight', 'class'=>'form-horizontal')) }}
						<div class="form-body">
							...
							<div class="form-group @if ($errors->has('name')) has-error @endif">
								...
								<div class="col-md-4">
									{{ Form::text('name', Input::old('name'), array('class'=>'form-control','placeholder'=>'Weight Name')) }}
							...
							<div class="form-group @if ($errors->has('sample')) has-error @endif">
								...
								<div class="col-md-4">
									{{ Form::text('sample', Input::old('sample'), array('class'=>'form-control','placeholder'=>'Weight Sample')) }}
