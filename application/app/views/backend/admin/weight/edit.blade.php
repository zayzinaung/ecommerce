		...
		<div class="col-md-7">
			...
			<div class="portlet box blue-madison">
				...
				<div class="portlet-body form">
					...
					<!-- BEGIN FORM-->
					{{ Form::model($weight, array('method' => 'PUT', 'route'=> array('admin.weight.update', $weight->id),  'class'=>'form-horizontal')) }}
					
						<div class="form-body">

							<h3 class="form-section">Weight Information<small> informations</small></h3>
							...
							<div class="form-group  @if ($errors->has('name')) has-error @endif">
								...
								<div class="col-md-4">
									{{ Form::text('name', $weight->weight_name, array('class'=>'form-control','placeholder'=>'Weight Name')) }}
							...
							<div class="form-group  @if ($errors->has('sample')) has-error @endif">
								...
								<div class="col-md-4">
									{{ Form::text('sample', $weight->weight_sample, array('class'=>'form-control','placeholder'=>'Weight Sample')) }}
