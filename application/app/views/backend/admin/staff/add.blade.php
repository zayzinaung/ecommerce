	...
	<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							{{ Form::open(array('url'=>'admin/staff', 'class'=>'form-horizontal')) }} 
								<div class="form-body">

									<h3 class="form-section">Staff <small>Basic informations</small></h3>
									
									@if ($errors->has('name') || $errors->has('salutation') || $errors->has('dob') || $errors->has('designation')) 
									...
									<div class="form-group @if ($errors->has('fin')) has-error @endif">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="fin" placeholder="" class="form-control" value="{{ Input::old('fin') }}" />
									...
									<div class="form-group @if ($errors->has('fin_exp_date')) has-error @endif">
										...
										<div class="col-md-4">
											<input type="text" name="fin_exp_date" placeholder="Date" class="form-control datepicker" value="{{ Input::old('fin_exp_date') }}" />
									...
									<div class="form-group @if ($errors->has('ppn')) has-error @endif">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="ppn" placeholder="No." class="form-control" value="{{ Input::old('ppn') }}" />
									...
									<div class="form-group @if ($errors->has('ppn_exp_date')) has-error @endif">
										...
										<div class="col-md-4">
											<input type="text" name="ppn_exp_date" placeholder="Date" class="form-control datepicker" value="{{ Input::old('ppn_exp_date') }}" />
									...
									<div class="form-group @if ($errors->has('dob')) has-error @endif">
										...
										* </span>
										...
										<div class="col-md-3">
											<input type="text" name="dob" placeholder="Date" class="form-control mask-dob" value="{{ Input::old('dob') }}" />
									...
									<div class="form-group @if ($errors->has('designation')) has-error @endif">
										...
										* </span>
										...
										<div class="col-md-3">
											<input type="text" name="designation" placeholder="Designation" class="form-control" value="{{ Input::old('designation') }}" />
									...
									<div class="form-group @if ($errors->has('join_date')) has-error @endif">
										...
										* </span>
										...
										<div class="col-md-3">
											<input type="text" name="join_date" placeholder="Date" class="form-control datepicker" value="{{ Input::old('join_date') }}" />
									...
									<div class="form-group @if ($errors->has('salary')) has-error @endif">
										...
										* </span>
										...
										<div class="col-md-2">
											<input type="text" name="salary" placeholder="Amount" class="form-control" value="{{ Input::old('salary') }}" />
