		...
		<div class="col-md-7">
			...
			<div class="portlet box blue-madison">
				<div class="portlet-title">
					<div class="caption">
						<span aria-hidden="true" class="icon-list"></span> Category Management
					</div>
					<div class="tools">
				...
				<div class="portlet-body form">
					...
					<!-- BEGIN FORM-->
					{{ Form::model($category, array('method' => 'PUT', 'route'=> array('admin.category.update', $category->id),  'class'=>'form-horizontal')) }}
						...
						<div class="form-body">
							...
							<div class="form-group  @if ($errors->has('name')) has-error @endif">
								...
								<div class="col-md-4">
									{{ Form::text('name', $category->category_name, array('class'=>'form-control','placeholder'=>'Category Name')) }}
