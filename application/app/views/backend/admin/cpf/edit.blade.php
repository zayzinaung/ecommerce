	...
	<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							{{ Form::model($cpf, array('method' => 'PUT', 'route'=> array('admin.cpf.update', $cpf->id), 'class'=>'form-horizontal')) }} 
							<input type="hidden" name="month" value="{{ $cpf->month }}">
								<div class="form-body">
									<div class="alert alert-info">
										Refresh CPF Payment For {{ date('F Y',strtotime('01-'.$cpf->month))}}
									</div>
									...
									<div class="form-group @if ($errors->has('payment_date')) has-error @endif">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="payment_date" class="form-control datepicker" value="{{ date('d-m-Y',$cpf->payment_date) }}">
