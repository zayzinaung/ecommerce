		...
		<div class="col-md-7">
			...
			<div class="portlet box blue-madison">
				...
				<div class="portlet-body form">
					...
					<!-- BEGIN FORM-->
					{{ Form::model($length, array('method' => 'PUT', 'route'=> array('admin.length.update', $length->id),  'class'=>'form-horizontal')) }}
						...
						<div class="form-body">
							...
							<div class="form-group  @if ($errors->has('name')) has-error @endif">
								...
								<div class="col-md-4">
									{{ Form::text('name', $length->length_name, array('class'=>'form-control','placeholder'=>'Length Name')) }}
							...
							<div class="form-group  @if ($errors->has('sample')) has-error @endif">
								...
								<div class="col-md-4">
									{{ Form::text('sample', $length->length_sample, array('class'=>'form-control','placeholder'=>'Length Sample')) }}
