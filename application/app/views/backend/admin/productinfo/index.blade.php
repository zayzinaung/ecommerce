		...
		<div class="portlet-body">
				...
				@if(User::hasPermTo(MODULE,'view'))
					<div class="btn-group">
						<a href="{{ URL::to('admin/color') }}" >
							<button id="sample_editable_1_new" class="btn grey-gallery">
								<i class="fa fa-plus"></i> Color Management
							</button>
						</a>
					</div>
					...
					<div class="btn-group">
						<a href="{{ URL::to('admin/size') }}" >
							<button id="sample_editable_1_new" class="btn grey-gallery">
								<i class="fa fa-plus"></i> Size Management
							</button>
						</a>
					</div>

					<div class="btn-group">
						<a href="{{ URL::to('admin/length') }}" >
							<button id="sample_editable_1_new" class="btn grey-gallery">
								<i class="fa fa-plus"></i> Length Management
							</button>
						</a>
					</div>

					<div class="btn-group">
						<a href="{{ URL::to('admin/weight') }}" >
							<button id="sample_editable_1_new" class="btn grey-gallery">
								<i class="fa fa-plus"></i> Weight Management
							</button>
						</a>
					</div>

					<div class="btn-group">
						<a href="{{ URL::to('admin/fuel') }}" >
							<button id="sample_editable_1_new" class="btn grey-gallery">
								<i class="fa fa-plus"></i> Fuel Management
							</button>
						</a>
					</div>
			...
			<div class="table-toolbar">
				@if(User::hasPermTo(MODULE,'create'))
					<div class="btn-group">
						<a href="{{ URL::to('admin/product_info/create') }}" >
			...
			<div class="table-responsive">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					<thead>
						<tr>
							<th>#</th>
							<th>Product Information Label</th>
							<th>Type</th>
					...
					<tbody>
						...
						@foreach ($productinfo as $row)
							<tr>
								...
								<td>
									@if(User::hasPermTo(MODULE,'view'))
										<a href="{{ URL::to('admin/product_info/'.$row->id) }}" class="btn green-meadow tooltips" data-placement="bottom" data-original-title="View"><span aria-hidden="true" class="icon-eye"></span></a>
									@endif
									@if(User::hasPermTo(MODULE,'edit'))
										<a href="{{ URL::to('admin/product_info/'.$row->id.'/edit/') }}" class="btn blue-hoki tooltips" data-placement="bottom" data-original-title="Edit"><span aria-hidden="true" class="icon-pencil"></span></a>
									@endif
									@if(User::hasPermTo(MODULE,'delete'))
										{{ Form::open(array('method' => 'DELETE', 'route' => array('admin.product_info.destroy', $row->id), 'style'=>'display: inline')) }}
