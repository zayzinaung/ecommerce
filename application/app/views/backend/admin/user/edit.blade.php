		...
		<div class="col-md-7">
			...
			<div class="portlet box blue-madison">
				...
				<div class="portlet-body form">
					...
					<!-- BEGIN FORM-->
					{{ Form::model($user, array('method' => 'PUT', 'route'=> array('admin.user.update', $user->id),  'class'=>'form-horizontal')) }}
						...
						<div class="form-body">
							...
							<div class="form-group @if ($errors->has('role_id')) has-error @endif">
								<label class="control-label col-md-3">Role Description<span class="required">* </span></label>
								<div class="col-md-4">
									<select class="form-control" name="role_id"  id="role_id">
										<option value="">Select</option>
										<?php foreach ($role as $row) {?>
										<option value="<?php echo $row->id; ?>" <?php echo ($row->id == $user->role_id )? 'selected' : '' ; ?> > <?php echo $row->description; ?> </option> 
										<?php } ?>
									</select>
