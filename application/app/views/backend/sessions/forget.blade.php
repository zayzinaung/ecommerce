...
<!--<![endif]-->
	...
	<head>
		<meta charset="utf-8"/>
		<title>Ikloudit E-commerce | System Forget Password</title>
	...
	<body class="login">
		...
		<div class="logo">
			<a href="#">
				<img src="{{ URL::to('backend/img/logo-login.png') }}" alt=""/>
			</a>
		</div>
		<!-- END LOGO -->
		...
		<div class="content">
			...
			<div class="form-actions">
				...
				<button type="button" class="btn blue pull-right forgot">Submit <i class="m-icon-swapright m-icon-white"></i></button>        
			</div>
			<!-- END LOGIN FORM -->
		</div>
		<!-- END LOGIN -->
	    	...
	    	$(function(){
				$('.forgot').click(function(){
					$.post('recover_password',{email : $('#inputEmail').val()},function(data){
						...
						$('#message').addClass('alert alert-warning show');
	        		});
				});
	    	});
		</script>
